...
function main() {
  ...
  operandoUno.addEventListener('input', function (e) {
    obtenerResultado(e).then(function (valorUno) {
      console.log('Primer operando: ' + valorUno);
      operandoDos.removeAttribute('disabled');
      operandoDos.addEventListener('input', function (e) {
        obtenerResultado(e).then(function (valorDos) {
...
function validaNumericos(event) {
  ...
  if (event.charCode >= 48 && event.charCode <= 57 || event.charCode === 45 && !input.includes('-')) {
...
function controllWheel() {
  ...
  var operandoUno = document.getElementById('operando-uno');
  var operandoDos = document.getElementById('operando-dos');
  operandoUno.addEventListener('wheel', function (e) {
    e.preventDefault();
  });
  operandoDos.addEventListener('wheel', function (e) {
    e.preventDefault();
  });
}
main();
